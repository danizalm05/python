...
bsdf.location = (200,-10)


material_output = nodes.get("Material Output")
material_output.location = (600,-30)
...
new_link = links.new(node_Val.outputs[0],  bsdf.inputs[19]) 
