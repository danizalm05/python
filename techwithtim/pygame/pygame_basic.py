...
class projectile(object):
    def __init__(self, x, y, radius, color, facing):
        ...
        self.color = color
        self.facing = facing
        self.vel = 8 * facing  # left right 1 -1
...
class enemy(object):
    walkRight = [pygame.image.load('img/R1E.png'), pygame.image.load('img/R2E.png'), pygame.image.load('img/R3E.png'),
    ...
    walkLeft = [pygame.image.load('img/L1E.png'), pygame.image.load('img/L2E.png'), pygame.image.load('img/L3E.png'),
